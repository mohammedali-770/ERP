...
<!-- verbatim-from: ../06-pbx-vendor-ticket.md#draft dequoted -->
<!--
  The support ticket body, de-quoted so it can be pasted straight into Yeastar's
  support form. Edit ../06-pbx-vendor-ticket.md and copy the change here; req-lint
