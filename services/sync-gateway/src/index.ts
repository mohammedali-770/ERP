/**
 * Service boundary: sync-gateway
 *
 * Handshake, event ingestion, projection dispatch, conflict incidents, device cursors.
 *
 ...
 */
export const SERVICE_NAME = 'sync-gateway' as const;
